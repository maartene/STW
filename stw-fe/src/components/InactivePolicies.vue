<template>
    <h3>Enact policies
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill text-info" viewBox="0 0 16 16"
                        data-bs-toggle="tooltip" data-bs-html="true" data-bs-placement="bottom" title="These policies are currently available for you to enact. The policies that are available to enact, are determined by your countries current ranking on various aspects (such as wealth, GDP, education, etc.)">
